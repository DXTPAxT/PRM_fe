...
class _$VoucherImpl implements _Voucher {
  ...
  @override
  String toString() {
    return 'Voucher(id: $id, code: $code, discount: $discount, minOrder: $minOrder, expiresAt: $expiresAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, code, discount, minOrder, expiresAt);
...
abstract class _Voucher implements Voucher {
  const factory _Voucher({
    ...
    @JsonKey(name: 'min_order') required final double minOrder,
